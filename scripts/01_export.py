...
if __name__ == "__main__":
    ...
    #                 image, bucket_id, folder_name, region_of_interest=aoi, resolution=10
    #             )  # CHANGE RESOLUTION to 10 for RAW images
    #             tasks.append(task)
    #         else:
    ...
    #         counts_completed, counts_failed, counts_running, counts_ready = (
    #             update_task_states_counts(task_statuses)
    #         )
    #         print(
    #             f"Ready: {counts_ready}, Running: {counts_running}, \
    ...
    #         )
    #         print(
    #             f"Ready: {counts_ready}, Running: {counts_running}, Completed: {counts_completed}/{image_list_size}, Failed: {counts_failed}"
    #         )
    #         time.sleep(60)
    #         print("===============================================")
    ...
    #     task_statuses = update_task_statuses(tasks, task_statuses)
    #     counts_completed, counts_failed, counts_running, counts_ready = update_task_states_counts(
    #         task_statuses
    #     )
    #     print(
    #         f"Ready: {counts_ready}, Running: {counts_running}, Completed: {counts_completed}/{image_list_size}, Failed: {counts_failed}"
    ...
    # )
    # print(
    #     f"Ready: {counts_ready}, Running: {counts_running}, Completed: {counts_completed}, Failed: {counts_failed}"
    # )
    # print("===============================================")

    # # Write final task statuses to a JSON file
    # with open("logs/task_statuses.json", "w") as f:
